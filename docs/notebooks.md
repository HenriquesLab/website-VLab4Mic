...
3. Open [Google Colab](https://colab.research.google.com/) and sign in
...
!!! question "Need help?"
    Refer to our [GitHub repository](https://github.com/HenriquesLab/VLab4Mic) or [open an issue](https://github.com/HenriquesLab/VLab4Mic/issues) if you run into problems.
